...
<title>OCDE: Output customization</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_frontend_node_modules_jasmine-spec-reporter_docs_customize-output.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
</pre><h2><a class="anchor" id="autotoc_md13160"></a>
...
<div class="line">  return getTime() + &#39; - &#39; + log;</div>
<div class="line">};</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md13161"></a>
