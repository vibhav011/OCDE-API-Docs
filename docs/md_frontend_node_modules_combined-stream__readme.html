...
<title>OCDE: combined-stream</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_frontend_node_modules_combined-stream__readme.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="line"> </div>
<div class="line">combinedStream.pipe(fs.createWriteStream(&#39;combined.txt&#39;));</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md5343"></a>
API</h1>
