...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_frontend_node_modules_cacache__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<p>Please refer to the <a class="el" href="md_frontend_node_modules_cacache__c_h_a_n_g_e_l_o_g.html">Changelog</a> for project history details, too.</p>
<p>Happy hacking!</p>
...
<h4><a class="anchor" id="autotoc_md4669"></a>
Example</h4>
...
<h4><a class="anchor" id="autotoc_md4671"></a>
Example</h4>
...
<h4><a class="anchor" id="autotoc_md4673"></a>
Note</h4>
...
<h4><a class="anchor" id="autotoc_md4674"></a>
Example</h4>
...
<p>See: <a href="#get-options">options</a></p>
<h4><a class="anchor" id="autotoc_md4676"></a>
Example</h4>
<div class="fragment"><div class="line">// Look up by key</div>
...
<h4><a class="anchor" id="autotoc_md4678"></a>
Fields</h4>
<ul>
...
<h4><a class="anchor" id="autotoc_md4679"></a>
Example</h4>
...
<h4><a class="anchor" id="autotoc_md4681"></a>
Example</h4>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md4682"></a>
&lt;a name="get-options"&gt;&lt;/a&gt; Options</h4>
<h4><a class="anchor" id="autotoc_md4683"></a>
...
<h4><a class="anchor" id="autotoc_md4684"></a>
...
<h4><a class="anchor" id="autotoc_md4685"></a>
&lt;tt&gt;opts.size&lt;/tt&gt;</h4>
...
<h3><a class="anchor" id="autotoc_md4686"></a>
...
<h4><a class="anchor" id="autotoc_md4687"></a>
Example</h4>
...
<p>See: <a href="#put-options">options</a></p>
<h4><a class="anchor" id="autotoc_md4689"></a>
Example</h4>
...
<div class="line">)</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md4690"></a>
&lt;a name="put-options"&gt;&lt;/a&gt; Options</h4>
<h4><a class="anchor" id="autotoc_md4691"></a>
&lt;tt&gt;opts.metadata&lt;/tt&gt;</h4>
<p>Arbitrary metadata to be attached to the inserted key.</p>
<h4><a class="anchor" id="autotoc_md4692"></a>
&lt;tt&gt;opts.size&lt;/tt&gt;</h4>
<p>If provided, the data stream will be verified to check that enough data was passed through. If there's more or less data than expected, insertion will fail with an <code>EBADSIZE</code> error.</p>
<h4><a class="anchor" id="autotoc_md4693"></a>
&lt;tt&gt;opts.integrity&lt;/tt&gt;</h4>
<p>If present, the pre-calculated digest for the inserted content. If this option is provided and does not match the post-insertion digest, insertion will fail with an <code>EINTEGRITY</code> error.</p>
<p><code>algorithms</code> has no effect if this option is present.</p>
<h4><a class="anchor" id="autotoc_md4694"></a>
...
<h4><a class="anchor" id="autotoc_md4695"></a>
&lt;tt&gt;opts.memoize&lt;/tt&gt;</h4>
<p>Default: null</p>
...
<h4><a class="anchor" id="autotoc_md4696"></a>
...
<h4><a class="anchor" id="autotoc_md4698"></a>
Example</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md4699"></a>
...
<h4><a class="anchor" id="autotoc_md4700"></a>
Example</h4>
...
<h4><a class="anchor" id="autotoc_md4702"></a>
Example</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md4703"></a>
...
<h4><a class="anchor" id="autotoc_md4705"></a>
Example</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md4706"></a>
...
<h4><a class="anchor" id="autotoc_md4707"></a>
Example</h4>
<div class="fragment"><div class="line">cacache.tmp.mkdir(cache).then(dir =&gt; {</div>
...
<div class="line">  })</div>
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md4708"></a>
...
<p>See: <a href="#tmp-options">options</a></p>
<h4><a class="anchor" id="autotoc_md4709"></a>
Example</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md4710"></a>
&lt;a name="tmp-options"&gt;&lt;/a&gt; Options</h4>
<h4><a class="anchor" id="autotoc_md4711"></a>
&lt;tt&gt;opts.tmpPrefix&lt;/tt&gt;</h4>
<p>Default: null</p>
<p>Prefix to append on the temporary directory name inside the cache's tmp dir.</p>
...
<h4><a class="anchor" id="autotoc_md4713"></a>
...
<h4><a class="anchor" id="autotoc_md4718"></a>
&lt;tt&gt;opts.log&lt;/tt&gt;</h4>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md4719"></a>
Example</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md4720"></a>
...
<h4><a class="anchor" id="autotoc_md4721"></a>
Example</h4>
